...
fun main() {
    var userInput = ""
    do {
        if (userInput.isNotBlank()) println("The goose is staring intently at you... Maybe it's time to change the channel?")
        println("Please enter the number of the habitat you would like to view:")
        userInput = readln()
        if (userInput != "exit") println(animals[userInput.toInt()])
